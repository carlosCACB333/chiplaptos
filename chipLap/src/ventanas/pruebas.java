...
public class pruebas extends javax.swing.JFrame {
         ...
         private void initComponents() {
                  ...
                  jButton1.setText("reporte de todo los alumnos");
                  ...
                  f_inicio.setDateFormatString("dd-MM-yyyy");

                  jButton2.setText("reporte por escuelas");
                  ...
                  layout.setHorizontalGroup(
                           ...
                           .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                             .addGroup(layout.createSequentialGroup()
                                                      .addGap(47, 47, 47)
                                                      .addComponent(f_inicio, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE))
                                             .addGroup(layout.createSequentialGroup()
                                                      .addGap(244, 244, 244)
         ...
         private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                  // TODO add your handling code here:
                  String escuel = jTextField1.getText();
                  HashMap parametros = new HashMap<>();
                  parametros.put("escuela", escuel);
                  JasperViewer reporte = control.showReport("reportes/alumnos_escuela.jasper", parametros);
                  try {
                           reporte.setTitle("alumnos de la escuela de "+escuel);
                  } catch (Exception e) {
                  }
         ...
         private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
                  ...
                  HashMap parametros = new HashMap<>();
                  JasperViewer reporte = control.showReport("reportes/facultad.jasper", parametros);
                  try {
                           reporte.setTitle("facultades ");
                  } catch (Exception e) {
                  }
